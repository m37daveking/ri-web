...
function ModuleCard({ module, index }: { module: typeof platformModules[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start py-16 border-b border-[var(--border)]"
    >
      <div>
        <div className="flex items-center gap-4 mb-4">
          <span className="text-label text-[var(--accent)]">{module.number}</span>
          <span className="text-label text-[var(--foreground-subtle)]">{module.subtitle}</span>
        </div>
        <h3 className="text-heading-sm mb-4">{module.title}</h3>
        <p className="text-[var(--foreground-muted)] leading-relaxed">{module.description}</p>
      </div>
      <div className="bg-[var(--background-secondary)] rounded-2xl p-6 md:p-8">
        <p className="text-label font-medium mb-4 text-[var(--foreground)]">Key Features</p>
        <ul className="space-y-3">
          {module.features.map((feature, i) => (
            <li key={i} className="flex items-start gap-3 text-[var(--foreground-muted)]">
              ...
              <span className="text-prose-sm">{feature}</span>
            </li>
          ))}
        </ul>
      </div>
      ...
      <main className="min-h-screen bg-[var(--background)]">
        ...
        <section ref={heroRef} className="pt-32 pb-16 md:pt-40 md:pb-24">
          <div className="container">
            ...
            <motion.h1
              className="text-heading-lg mb-6 max-w-4xl"
              initial={{ opacity: 0, y: 20 }}
              animate={heroInView ? { opacity: 1, y: 0 } : {}}
            ...
            >
              RIOS
              <br />
              <span className="text-prose font-light">
                Radical Intelligence Operating System
              </span>
            </motion.h1>
            <motion.p
              className="text-lead max-w-2xl mb-12"
              initial={{ opacity: 0, y: 20 }}
              animate={heroInView ? { opacity: 1, y: 0 } : {}}
        ...
        <section ref={dimensionsRef} className="py-16 md:py-24 bg-[var(--background-secondary)]">
          <div className="container">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <p className="text-label mb-4">ASSESSMENT FRAMEWORK</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {dimensions.map((dimension, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-6 border border-[var(--border)] hover:border-[var(--accent)] hover:shadow-lg transition-all"
                >
                  ...
                  <p className="text-prose-sm">{dimension.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <motion.div
              ...
              className="mb-8"
            >
              <p className="text-label mb-4">PLATFORM MODULES</p>
              <h2 className="text-heading-md mb-4">
        ...
        <section className="py-16 md:py-24 bg-[var(--background-secondary)]">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[var(--accent)] text-white flex items-center justify-center mx-auto mb-6 text-xl font-light">
                  1
                </div>
                <h3 className="font-medium mb-3">Complete the Assessment</h3>
                <p className="text-prose-sm">
              ...
              >
                ...
                <h3 className="font-medium mb-3">Explore Opportunities</h3>
                <p className="text-prose-sm">
              ...
              >
                ...
                <h3 className="font-medium mb-3">Build Your Roadmap</h3>
                <p className="text-prose-sm">
        ...
        <section className="py-24 md:py-32">
          <div className="container">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="p-12 md:p-16 bg-[var(--background-secondary)] rounded-3xl">
                <h2 className="text-heading-md mb-4">
                  Ready to assess your AI readiness?
                </h2>
                <p className="text-[var(--foreground-muted)] mb-10 max-w-xl mx-auto">
